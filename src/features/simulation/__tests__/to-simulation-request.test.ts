...
const CANON_MATERIAL_ID = "mat_canon";
const CANON_SPEC = canonRequest.sources[0].spec as unknown as SpeakerSpec;
const CANON_MATERIAL = canonRequest.materials
  .mat_canon as unknown as MaterialSpec;

/** La sala de CANON-01 (§A.1): 20 × 12 × 6 m, α = 0.10 uniforme, audiencia en toda la planta. */
function canonDocument(): RoomDocument {
...
const canonSource: ResolvedSpeakerSource = {
  nodeId: "spk_1",
...
const canonSimulation: SceneSimulation = sceneSimulationSchema.parse({
